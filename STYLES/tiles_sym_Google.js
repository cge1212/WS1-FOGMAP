const styleGM = {
    ...
    "layers": [
    {
      "id": "background",
      "type": "background",
      "paint": {"background-color": "rgb(248,247,247)"}
    },
    {
      "id": "park",
      "type": "fill",
    ...
    },
    {
      ...
      "paint": {"fill-color": "rgba(195, 241, 213, 1)"}
    },
    {
      "id": "landuse_hospital",
      "type": "fill",
    ...
    },
    {
      ...
      "paint": {"fill-color": "rgb(144,218,238)"}
    },
    {
      "id": "landcover_sand",
      "type": "fill",
    ...
    },
    {
      ...
      "layout": {"line-join": "round"},
      "paint": {
        "line-color": "rgba(139, 204, 183, 1)",
        "line-width": {"base": 1, "stops": [[14, 1], [20, 2]]}
      }
    },
    {
    ...
    },
    {
      ...
      "layout": {"line-cap": "round", "line-join": "round"},
      "paint": {
        "line-color": {"base": 1, "stops": [[5, "#8BA5C1"], [6, "#8BA5C1"]]},
        "line-width": {"base": 1.2, "stops": [[5, 0], [7, 1], [20, 18]]}
      }
    },
    {
    ...
    },
    {
      ...
      "paint": {
        ...
        "fill-outline-color": {"stops": [[2, "#dfe1ea"], [2, "#dfe1ea"]]}
      }
    }
  ],
  "id": "osm-liberty"
